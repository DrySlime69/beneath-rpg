class GameScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.hotbarDisplaySlots = Array.from(document.querySelectorAll('#inventory .slot'));
    ...
    this.mineKey = this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.SPACE);
    ...
    this.cameras.main.startFollow(this.followTarget, true, 0.06, 0.06);
  ...
  update() {
    ...
    this.followTarget.x = this.player.x * this.tileSize + this.tileSize / 2;
    this.followTarget.y = this.player.y * this.tileSize + this.tileSize / 2;
  }
}
